...
const Testimonial = () => {
  ...
  return (
   ...
   <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10  rounded-full px-6 py-1.5">
        ...
        <Title title="Don't just take our words" description="Here what our users say about us . we are always looking for ways to improve. If you have a positive experience  with us . leavve a review. " />
